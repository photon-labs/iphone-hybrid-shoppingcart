...
- (BOOL)application:(UIApplication*)application didFinishLaunchingWithOptions:(NSDictionary*)launchOptions
{
    ...
    BOOL status = [self checkReachabilityStatus];
    if(!status)
    {
    ...
    else
    {
        ...
        self.viewController.startPage = [self parseConfigFile];
...
-(NSString*) parseConfigFile
{
    ConfigurationReader *configReader = [[ConfigurationReader alloc] init];
    [configReader parseXMLFileAtURL:@"phresco-env-config" environment:nil];
